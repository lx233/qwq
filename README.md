...
See Not Pure Poole in action with [the demo site](https://lx233.github.io/not-pure-poole/).
...
- If your site is hosted on GitHub Pages, you can use [`jekyll-remote-theme`](https://github.com/benbalter/jekyll-remote-theme) to import the master branch of Not Pure Poole.
    ...
    2. Add the below lines into your `_config.yml`.
        ...
        remote_theme: lx233/not-pure-poole
        ```

## Usage

You can read this [example post](https://lx233.github.io/not-pure-poole/2020/09/29/welcome-to-not-pure-poole/) to see the rendering result in this theme, and put the [source](_posts/2020-09-29-welcome-to-not-pure-poole.md) aside to learn some basic usages.
...
```yml
- title: Email
  url: mailto://lx233@gmail.com
  icon: fas fa-envelope
- title: Twitter
  url: https://twitter.com/lx233
  icon: fab fa-twitter
- title: GitHub
  url: https://github.com/lx233/not-pure-poole
  icon: fab fa-github
```
